...
export function Footer() {
  ...
  />
            ...
            <div className="ftr-social">
              ...
              <a href="https://wa.me/971581289605" target="_blank" rel="noopener noreferrer" className="ftr-soc-btn" style={{ color: "#25d366" }}>
            ...
            {branches.map((b) => (
              <div key={b.name} className="ftr-branch">
                ...
                <div className="ftr-cta-row">
                  ...
                  <a href={`https://wa.me/971581289605?text=${encodeURIComponent(b.waText)}`} target="_blank" rel="noopener noreferrer" className="ftr-btn-wa">
